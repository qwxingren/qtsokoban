...
public:
  Bookmark(int _num);
  Bookmark(int _collection, int _level);
  ...
  void completed_set(int _collection, int _level, int _moves, History *_h);
  bool completed_goTo(LevelMap *_map, History *_h);
  bool goTo(LevelMap *_map, History *_h);

private:
  void fileName(QString &p);
  void completed_fileName(QString &p);
