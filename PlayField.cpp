...
PlayField::PlayField(QWidget *parent, const char *name)
  ...
  animDelay_ = settings.value("settings/animDelay", 2).toInt();
...
PlayField::mouseMoveEvent(QMouseEvent *e) {
  ...
  dragXpm_ = dragXpm_.scaled(size_, size_);
  ...
  paint.setBackground(background_);
...
PlayField::setSize(int w, int h) {
  ...
  collXpm_ = collXpm_.scaled(collRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
  ltxtXpm_ = ltxtXpm_.scaled(ltxtRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
  lnumXpm_ = lnumXpm_.scaled(lnumRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
  stxtXpm_ = stxtXpm_.scaled(stxtRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
  snumXpm_ = snumXpm_.scaled(snumRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
  ptxtXpm_ = ptxtXpm_.scaled(ptxtRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
  pnumXpm_ = pnumXpm_.scaled(pnumRect_.size(), Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
